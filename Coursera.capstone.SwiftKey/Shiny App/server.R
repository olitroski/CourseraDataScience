...
ngram1 <- readRDS("data/ngram1.rds")
ngram2 <- readRDS("data/ngram2.rds")
ngram3 <- readRDS("data/ngram3.rds")
ngram4 <- readRDS("data/ngram4.rds")
ngram5 <- readRDS("data/ngram5.rds")
